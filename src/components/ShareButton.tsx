    ...
    <>
      <div className={cn("relative", className)}>
        <button
          ...
          className={cn(
            "group relative inline-flex items-center gap-1.5 sm:gap-2 px-3 sm:px-5 py-2 sm:py-2.5 rounded-full transition-all duration-300",
            "border-2 overflow-hidden whitespace-nowrap text-sm sm:text-base",
            isOpen 
        ...
        >
          ...
          <Share2 className={cn(
            "w-4 h-4 sm:w-5 sm:h-5 flex-shrink-0 transition-all duration-300 relative z-10",
            isOpen && "rotate-12",
